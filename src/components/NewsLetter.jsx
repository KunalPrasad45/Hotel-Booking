const NewsLetter = () => {
  return (
    <div className="w-full mx-auto flex py-16 md:flex-row flex-col border border-gray-500/30 rounded-lg items-start md:items-center justify-between gap-5 text-sm max-w-5xl bg-white p-8">
      <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
          ...
          />
          <button className="bg-blue-700 transition-all px-6 py-2 rounded text-white font-medium">
            Subscribe
          </button>
        </div>
      </div>
