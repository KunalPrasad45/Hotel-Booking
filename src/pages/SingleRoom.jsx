...
const SingleRoom = () => {
  ...
  // agar roomData abhi tak load nahi hua to safe check
  if (!room) {
    return (
      <div className="py-24 min-h-screen flex justify-center items-center">
        <p className="text-gray-600 text-lg">Room not found or loading...</p>
      </div>
    );
  }
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-1">
                  ...
                  <span className="font-semibold">{room.hotel.rating}</span>
                </div>
                <div
