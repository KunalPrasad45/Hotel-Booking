...
const Signup = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center">
      ...
      >
        <h1 className="text-3xl font-medium">Signup</h1>
        <p className="text-sm text-gray-500 mt-2">Please sign up to continue</p>
        ...
        <div className="mt-4 text-left">
          <label className="text-sm font-medium text-gray-700">Signup as:</label>
          <select
            name="role"
            value={formData.role}
            onChange={onChangeHandler}
